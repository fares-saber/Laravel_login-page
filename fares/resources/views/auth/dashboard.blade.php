...
<div class="container mx-auto px-4">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('admin.students.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-lg text-center transition duration-200">
                <i class="fas fa-user-plus text-2xl mb-2"></i>
                <p>Add Student</p>
            </a>
            <a href="{{ route('admin.teachers.create') }}" class="bg-green-500 hover:bg-green-600 text-white py-3 px-4 rounded-lg text-center transition duration-200">
                <i class="fas fa-chalkboard-teacher text-2xl mb-2"></i>
                <p>Add Teacher</p>
            </a>
            <a href="{{ route('admin.attendance.create') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white py-3 px-4 rounded-lg text-center transition duration-200">
...
@endsection
<!-- credit :eng/mohamed algandor for teaching me
made by Fares  -->